...
function AccountMenu({ isAdmin, onClose, onSignOut }: { isAdmin: boolean; onClose: () => void; onSignOut: () => void }) {
  const customerLinks = [{ href: "/cuenta", label: "Perfil" }, { href: "/cuenta?seccion=pedidos", label: "Pedidos" }, { href: "/notificaciones", label: "Notificaciones" }, { href: "/cuenta?seccion=favoritos", label: "Favoritos" }, { href: "/personalizados?vista=conversaciones", label: "Chat de personalizados" }];
