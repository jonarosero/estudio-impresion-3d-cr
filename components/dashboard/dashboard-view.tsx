...
function QuotesPanel() {
  ...
  async function convertQuote() {
    if (!selected) return;
    if (!pricesAreValid) {
      setConversionMessage("Ingresa un precio por unidad mayor a $0 y un envío no negativo.");
      return;
    }
